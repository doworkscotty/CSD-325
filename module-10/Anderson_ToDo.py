#Scott Anderson Module 10.2 Assignment
...
class Todo(tk.Tk):
    def __init__(self, tasks=None):
        ...
        self.title("Anderson-ToDo")  
        self.geometry("300x400")

        
        menu_bar = tk.Menu(self, bg="lightblue", fg="black")  
        ...
        instructions = tk.Label(self.text_frame, text="Enter a task and press Enter to add.\nRight-click a task to delete.", fg="blue")
